...
X1 = 20;                %Number of channels on the line array
N = 2^12;               %Sample size
B = 20;                 %Total number of Blocks per position
fs = 24096;             %Sampling frequency.
df = fs/N;              %frequency resolution
dt = 1/fs;              %time increment of data
T = N*dt;               %total time in each block of data [s]
De = 0.05;              %nozzle diameter [m]
Ue = 125;               %exit velocity [m/s]
...
dx = 0.015;             %This is the intermicrophone spacing on the line array [m]
xlab = [dx:dx:X1*dx]/De;
