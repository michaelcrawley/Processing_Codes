function [phi R2] = ADI( A,B,C,D,E,F , phi , tol , maxIt )
...
%		A	[1 K]or[M N]	-N sub-diagonal  %As
%		B	[1 K]or[M N]	-1 sub-diagonal  %Aw
%		C	[1 K]or[M N]	Main-diagonal
%		D	[1 K]or[M N]	+1 super-diagonal %Ae
%		E	[1 K]or[M N]	+N super-diagonal %An
