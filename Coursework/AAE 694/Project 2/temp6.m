function [] = temp6(dx,dt,Mx,My)
    ...
    for i = 1:imax %time step loop
        ...
        if My == 0 %radiation boundary conditions
            Drho(end-2:end,4:end-3,4) = A(end-2:end,4:end-3).*(-dqdx{1}(end-2:end,4:end-3))+B(end-2:end,4:end-3).*(-dqdy{1}(end-2:end,4:end-3))-C(end-2:end,4:end-3).*rho(end-6:end,:,4);
            Du(end-2:end,4:end-3,4) = A(end-2:end,4:end-3).*(-dqdx{2}(end-2:end,4:end-3))+B(end-2:end,4:end-3).*(-dqdy{2}(end-2:end,4:end-3))-C(end-2:end,4:end-3).*u(end-6:end,:,4);
            Dv(end-2:end,4:end-3,4) = A(end-2:end,4:end-3).*(-dqdx{3}(end-2:end,4:end-3))+B(end-2:end,4:end-3).*(-dqdy{3}(end-2:end,4:end-3))-C(end-2:end,4:end-3).*v(end-6:end,:,4);
        else %outflow boundary conditions          
