...
%Load data
load('Test Reconstructions/FFNBP_arch512_St005UVf.mat')
...
%     disp(['Processing interation: ',num2str(counter),'/',num2str(L)]);
    ...
    Uz(:,:,n) = Uz_tmp;
    Ur(:,:,n) = Ur_tmp;    
    [potential,solenoidal] = Helmholtz_Decomposition2DCyl_v3(z,r,Uz_tmp,Ur_tmp);
...
save('s_Ur.mat','s_Ur','z','r','t','lafpa');
