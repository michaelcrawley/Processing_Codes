function ButtonName=questdlg_timeout(Question,Title,timeout,Btn1,Btn2,Btn3,Default)
...
%
%  The third argument is a timeout (seconds) on the dialog box. If the 
%  timeout expires, the ButtonName will return ''.
%
%  The buttons can be changed by adding a fourth argument which specifies
%  the default Button:
%
