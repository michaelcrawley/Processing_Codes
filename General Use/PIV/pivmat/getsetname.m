...
%GETSETNAME  Get the name of the current set (directory)
...
%   DIR.
%
%   For DaVis files, the SET name corresponds to the name of the folder
%   where the VC7 or IM7 files are stored.
%
%   See also PWD, LOADVEC, GETVAR.
