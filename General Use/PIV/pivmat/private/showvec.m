...
listbgmode = {'','off','norm','norm2d','norm3d','ux','uy','uz','vx','vy','vz','u','v','w','ken','angle','rad','deg',...
    'curl', 'rot',  'absrot', 'div', 'ens', 'strain', 'eps', 'duxdx', 'duxdy', 'duydx', 'duydy', 'duzdx', 'duzdy', 'q',...
    ...
    'uxuy','uyux','uxuz','uzux','uyuz','uzuy','uxux','uyuy','uzuz','tauxx','tauxy','tauyx','tauyy','tauzz','tauxz','tauzx','tauyz','tauzy'
    };
