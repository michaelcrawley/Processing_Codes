function SoundProcess_v14b(PARAMS,savedir)
...
%has been removed.  An additional optional input (savedir)
%has been included, which allows the user to change the save directory of
%the data.  New subfolders for saving data are created.  An
%additional .mat file consisting of all data in the fft, S.fft, and .set
%files is created and saved.  All modifications are noted
