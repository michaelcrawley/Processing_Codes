function [alpha,alpha_s] = atmAbsorption_v2(f,T,P,RH,SW)
%v2 - includes switch to scale data to standard day.
% Function calls:
%   atmAbsorption_v2(f,T,P,RH,'Standard') - Correct to standard day
%   atmAbsorption_v2(f,T,P,RH,'Lossless') - Lossless propagation
%  - Also outputs both the correctstandard day absorption rate.
%
...
if strcmpi('Standard',SW)
    alpha_s = standardDay(f);   %gets standard day conditions
else
    alpha_s = 0;
end
